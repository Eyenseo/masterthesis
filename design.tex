...
\section{Support Cyclic Graphs and Struct Inheritance}
  ...
  \subsection{Memory Layout}
    ...
    The \codr{PhantomData<T>} provides the compiler with information which \enquote{is used when computing certain safety properties.}\autocite[std::marker::PhantomData]{rust-doc}.
  ...
  \subsection{Consequences of \texttt{Ptr<T>}}\label{sec:badptr}
    ...
    To also support that kind of parallelism, at a field level, all fields in the objects would have to be enclosed in something like an \UnsafeCellT for interior mutability.
