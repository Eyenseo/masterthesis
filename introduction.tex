...
\section{SKilL}\label{sec:skill}
  ...
  \subsection{\glsentrytext{skill} Usage}
    ...
    \subsection{\glsentrytext{skill} Internals}\label{ssec:skillInter}
    ...
    \subsubsection{Reading and Writing}\label{sssec:rwSkill}
...
\section{Rust}
  ...
  \subsection{Errors and Null}\label{ssec:rustErr}
